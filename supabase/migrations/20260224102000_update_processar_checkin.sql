CREATE OR REPLACE FUNCTION processar_checkin(
    ...
    p_group_id uuid DEFAULT NULL -- Parâmetro adicionado
)
RETURNS jsonb
LANGUAGE plpgsql
SECURITY DEFINER
...
BEGIN
    ...
    -- Inserir checkin incluindo o group_id
    INSERT INTO checkins(user_id, group_id, title, type, duration_minutes, image_url, xp_earned, coins_earned)
    VALUES (v_user_id, p_group_id, p_title, p_type, p_duration_minutes, p_image_url, v_xp_earned, v_coins_earned)
